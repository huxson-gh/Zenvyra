  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t ">
      ...
      <div className="w-full sm:min-w-60 sm:w-60">
        ...
        {/* Category Filter */}
        <div
          className={`border border-gray-400 pl-5 py-3 mt-6 ${showFilter ? "block" : "hidden"} sm:block`}
        >
        ...
        {/* Sub-Category Filter */}
        <div
          className={`border border-gray-400 pl-5 py-3 my-5 ${showFilter ? "block" : "hidden"} sm:block`}
        >
